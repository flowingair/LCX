...
void help(const char* name)
{
	...
	fprintf(stdout,"	-ulisten <local port1>	<local port2>\n");
	fprintf(stdout,"	-tran		<local port>	 <remote host>	<remote port>\n");
	fprintf(stdout,"	-utran	 <local port>	 <remote host>	<remote port>\n");
	fprintf(stdout,"	-slave	 <remote host1> <remote port1> <remote host2> <remote port2>\n");
	fprintf(stdout,"	-uslave	<remote host1> <remote port1> <remote host2> <remote port2>\n\n");
...
int main_func(int argc,char**argv)
{
	...
	const char* command[] = {"-about","-listen","-slave","-tran","-ulisten","-uslave","-utran"};
